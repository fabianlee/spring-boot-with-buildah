package org.fabianlee.springbootwithbuildah;
...
public class Info {
    ...
    public @ResponseBody String metrics() {
        ...
        kv.put(String.format("springbootwithbuildah{version=\"%s\"}",buildProperties.getVersion().toString()),"0.0");
        kv.put(String.format("springbootwithbuildah{name=\"%s\"}",buildProperties.getName().toString()),"0.0");
        kv.put(String.format("springbootwithbuildah{group=\"%s\"}",buildProperties.getGroup().toString()),"0.0");
